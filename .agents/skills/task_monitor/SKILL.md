---
name: task_monitor
description: Automatically monitors background tasks (like git downloads, gradle builds, or compilations) by scheduling a 60s check timer, analyzing execution logs, detecting frozen tasks, and applying fallback solutions.
---
